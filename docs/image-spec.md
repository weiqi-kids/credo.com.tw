...
- **硬限制：照片中出現人物時，必須是台灣人／東亞面孔**（含背影、手部——膚色與情境要像台灣）；歐美面孔一律禁用。場景也不得是明顯歐美街景/建築（歐式老宅、西式路標）。無人物的物件/文件/建築照不在此限，但優先台灣場景。搜尋關鍵字加 taiwan／taipei／asian，Pexels 上台灣攝影師的作品優先。
- **每張含人物或場景的圖，下載後必須用 Read 工具實際看過再採用**——不能只看標題猜。

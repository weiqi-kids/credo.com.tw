...
const STYLE_RULES = `寫作鐵則（每一條都有程式檢查，違反直接退件，請逐條自查後再輸出）：
- 全形括號（）在任何欄位都絕對禁止——包括補充判決字號、原名、說明，一律改寫成敘述句或刪除。
- 全部欄位（含 court 法院怎麼說）一律使用化名，判決原文的真實姓名一個字都不能出現；判決字號照原樣保留。
- 忠實鐵則：只能寫判決原文有的事實。原文沒寫的（親屬關係、時間長短、法院查證方式、當事人動機）一律不寫，寧可短，禁止腦補；需要推論時用「可能」「推測」明示。
- 禁止 AI 味語言：全形括號（）補充句、破折號（——）下定義或插補、「不僅…更/還」「不是/不只是…而是/更是」「並非…而是」、值得注意的是、值得一提、換句話說、總的來說、總結來說、總而言之、綜上所述、歸根結底、整體而言、真正的問題/關鍵是、扮演…角色、至關重要、不可或缺、舉足輕重、隨著…的發展/普及、在…的今天、讓我們、不妨、你是否曾、希望本文、的燈塔、的見證、重要里程碑、首先…其次…最後、研究顯示、有研究指出、專家認為、學者認為、普遍認為、有人說、模板化第一人稱開場。對比句用「是Y，而非X」或正面直述；引用主張需附判決字號/法條，禁模糊引用。
...
5. ai_tone_ok：有無 AI 味句型——全形括號（）、破折號（——）下定義、不是/不只是…而是、值得注意的是、換句話說、總的來說/綜上所述/總而言之/歸根結底、至關重要/舉足輕重、隨著…的發展、研究顯示/專家認為/普遍認為、讓我們、首先其次最後、模板化第一人稱開場等
